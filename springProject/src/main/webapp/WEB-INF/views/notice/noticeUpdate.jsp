...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="updateForm" method="post" action="notice-update.do">
                <table algin="center">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="writer" class="form-control" value="${notice.noticeWriter }" name="noticeWriter" readonly></td>
                    </tr> 
                    <tr>
